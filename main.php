...
// cli
$shortopts = '';
$longopts = array('project_path', 'scan_path', 'scan_type', 'encoding:');
$options = getopt($shortopts, $longopts);
$project_path = $options['project_path'];
$scan_path = $options['scan_path'];
$scan_type = $options['scan_type'];
$encoding = 'UTF-8' ;  //CMS的编码   UTF-8 或者  GBK
} else {
...
//1、从web ui中获取并加载项目工程
$project_path = '/home/bitrix/modules/main';//$_POST['prj_path'] ;  //扫描的工程路径
$scan_path = '/home/bitrix/modules/main';//$_POST['path'] ;   //扫描文件路径
$scan_type = 'xss';//$_POST['type'] ;     //扫描的类型
$encoding = $_POST['encoding'] ;  //CMS的编码   UTF-8 或者  GBK
...
system("mkdir -p $serialPath");
$serialPath = "$serialPath/" . $fileName;

if (!is_file($serialPath)){
    //创建文件
    print "serialPath $serialPath\n";
